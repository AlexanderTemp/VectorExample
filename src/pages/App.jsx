          ...
          <ReactFlowProvider>
            <div className="flex flex-col basis-[12%] border-r-2 border-slate-700">
              ...
              <div className="flex flex-col gap-2 py-4 border-b-2 border-slate-800 items-center px-2">
                <div className="w-[100%] text-slate-100 px-1 py-1 rounded-lg text-center bg-[#25274E] text-xl cursor-pointer hover:shadow-md hover:shadow-indigo-400" onDragStart={(event) => onDragStart(event, "vector")}
                  draggable>
                  Vector
                </div>
